...
class DataProcessing():
    ...
    def __init__(self, DATAPATH = 'aksharantar_sampled', source_lang = 'en', target_lang = "hin"):
    
        self.source_lang = source_lang
        self.target_lang = target_lang
    
        self.trainpath = os.path.join(DATAPATH, target_lang, target_lang+"_train.csv")
        self.valpath = os.path.join(DATAPATH, target_lang, target_lang+"_valid.csv")
        self.testpath = os.path.join(DATAPATH, target_lang, target_lang+"_test.csv")
...
dataPreprocessor = DataProcessing()